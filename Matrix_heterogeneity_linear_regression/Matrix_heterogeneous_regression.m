function [Results,results,Results_opt,results_opt,...
    ...
    k,a,lambda_left,lambda_right,c,min_class_num,disp_if,initial_if,full_if,initial_position)
...
if isempty(initial_position)
    initial_position = 'D:\MATLAB_Document3\ADMM_BCD_new\多方法结果\初值\非平衡设计\mu=0.5\AR0.2\'; %初值结果存放地址
end
...
save('D:\MATLAB_Document3\ADMM_BCD_new\多方法结果\PROPOSED\非平衡设计\mu=0.5\AR0.2\RResults.mat','Results','results','Results_opt',...
