function [DATA_struct,data,DATA_opt,data_opt] = admm_lambda(ifauto,lambda_size,lambda_start_point,change_constant,log_change_constant,beta0,gamma0,sample_size,row_size,col_size,iter_max1,iter_max1_interval,iter_max2,iter_max2_interval,iter_max3,iter_max3_interval,...
                                                                  ...
                                                                  store_beta,store_gamma,beta_real,gamma_real,min_class_num,one_beta,one_gamma,HH_p,HH_q,E,full_if)
%-------------------------------------------函数功能-----------------------------------------------%
...
if ifauto == 1
    ...
    [lambda_left_back,lambda_right_back] = interval_lambda(lambda_start_point,change_constant,sample_size,row_size,col_size,iter_max1_interval,iter_max2_interval,iter_max3_interval,...
                                                               eps1_interval,eps2_interval,eps3_interval,beta0,gamma0,H_p,H_q,X,y,k,a,c,v,w,kesai,yita,v_vec,w_vec,kesai_vec,...
                                                               yita_vec,store_beta,store_gamma,beta_real,gamma_real,min_class_num,one_beta,one_gamma,HH_p,HH_q,E,full_if);
...
[beta_back,gamma_back,class_back,index_back,subgroup_number,...
               per_if,mse_beta,mse_gamma,sc,BIC_back,BIC_part2_back,wucha_back,convergence,iter_back,Data] = admm4_mex(sample_size,row_size,col_size,iter_max1,iter_max2,iter_max3,eps1,eps2,eps3,...
                                                                               beta0,gamma0,H_p,H_q,X,y,k,a,Lambda(i),c,v,w,kesai,yita,v_vec,w_vec,kesai_vec,...
                                                                               yita_vec,store_beta,store_gamma,beta_real,gamma_real,one_beta,one_gamma,HH_p,HH_q,E,full_if);
