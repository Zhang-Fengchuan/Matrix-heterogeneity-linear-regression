function [lambda_left_back,lambda_right_back] = interval_lambda(lambda_start_point,change_constant,sample_size,row_size,col_size,iter_max1_interval,iter_max2_interval,iter_max3_interval,...
...
eps2 = eps2_interval;
eps3 = eps3_interval;
[~,~,~,~,subgroup_number_start,~,~,~,~,~,~,~,~,~,~] = admm4_mex(sample_size,row_size,col_size,iter_max1,iter_max2,iter_max3,eps1,eps2,eps3,...
...
while subgroup_number_left==sample_size
    ...
    [~,~,~,~,subgroup_number_left,~,~,~,~,~,~,~,convergence,iter_back,DATA] = admm4_mex(sample_size,row_size,col_size,iter_max1,iter_max2,iter_max3,eps1,eps2,eps3,...
...
while subgroup_number_right == 1
    ...
    [~,~,~,~,subgroup_number_right,~,~,~,~,~,~,~,~,~,~] = admm4_mex(sample_size,row_size,col_size,iter_max1,iter_max2,iter_max3,eps1,eps2,eps3,...
...
lambda_left = lambda_left*change_constant;
[~,~,~,~,subgroup_number_left,~,~,~,~,~,~,~,~,~,~] = admm4_mex(sample_size,row_size,col_size,iter_max1,iter_max2,iter_max3,eps1,eps2,eps3,...
                                                                               beta0,gamma0,H_p,H_q,X,y,k,a,lambda_left,c,v,w,kesai,yita,v_vec,w_vec,kesai_vec,...
                                                                               yita_vec,store_beta,store_gamma,beta_real,gamma_real,one_beta,one_gamma,HH_p,HH_q,E,full_if);
end
