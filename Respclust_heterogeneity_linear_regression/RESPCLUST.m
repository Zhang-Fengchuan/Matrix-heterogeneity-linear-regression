function [Result_table, Result_table_summary] = RESPCLUST(simulation_size, Data_x, y_real, sample_size, row_size, col_size, beta_real, gamma_real,...
...
for i = 1:simulation_size
    y = y_real(:, i);
    x = Data_x(:,:,:,i);
    [result] = respclust_single_regression(x, y, sample_size, row_size, col_size, beta_real, gamma_real,...
                                            eps_initial, iter_max_initial_in, k_min, k_max, num_time);
