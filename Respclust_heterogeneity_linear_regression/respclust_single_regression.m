function [result] = respclust_single_regression(x, y, sample_size, row_size, col_size, beta_real, gamma_real,...
...
[class, k_best] = respclust_k_means_sc(y, k_min, k_max, num_time, sample_size);
