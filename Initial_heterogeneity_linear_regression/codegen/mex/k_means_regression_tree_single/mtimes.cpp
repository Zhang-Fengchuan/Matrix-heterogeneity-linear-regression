...
static emlrtRSInfo ud_emlrtRSI{
    142,      // lineNo
    "mtimes", // fcnName
    "D:\\MATLAB2023A\\toolbox\\eml\\eml\\+coder\\+internal\\+blas\\mtimes.m" // pathName
};
...
static emlrtRTEInfo ge_emlrtRTEI{
    ...
    20,       // colNo
    "mtimes", // fName
    "D:\\MATLAB2023A\\toolbox\\eml\\eml\\+coder\\+internal\\+blas\\mtimes.m" // pName
};
              ...
              ::coder::array<real_T, 1U> &C)
{
  ...
  if ((A.size(0) == 0) || (A.size(1) == 0) || (B.size(0) == 0)) {
    int32_T loop_ub;
    C.set_size(&he_emlrtRTEI, &sp, A.size(1));
    loop_ub = A.size(1);
    ...
    C.set_size(&ge_emlrtRTEI, &b_st, A.size(1));
              ...
              ::coder::array<real_T, 2U> &C)
{
  ...
  if ((A.size(1) == 0) || (B.size(0) == 0) || (B.size(1) == 0)) {
    int32_T loop_ub;
    C.set_size(&he_emlrtRTEI, &sp, 1, B.size(0));
    loop_ub = B.size(0);
    for (int32_T i{0}; i < loop_ub; i++) {
      C[i] = 0.0;
    }
    ...
    ldb_t = (ptrdiff_t)B.size(0);
    ldc_t = (ptrdiff_t)1;
    C.set_size(&ge_emlrtRTEI, &b_st, 1, B.size(0));
...
void b_mtimes(const emlrtStack &sp, const ::coder::array<real_T, 1U> &A,
              const ::coder::array<real_T, 2U> &B,
              ::coder::array<real_T, 2U> &C)
{
  ptrdiff_t k_t;
  ...
  if ((A.size(0) == 0) || (B.size(0) == 0) || (B.size(1) == 0)) {
    int32_T loop_ub;
    C.set_size(&he_emlrtRTEI, &sp, 1, B.size(1));
    loop_ub = B.size(1);
    for (int32_T i{0}; i < loop_ub; i++) {
      C[i] = 0.0;
    }
    ...
    ldb_t = (ptrdiff_t)B.size(0);
    ldc_t = (ptrdiff_t)1;
    C.set_size(&ge_emlrtRTEI, &b_st, 1, B.size(1));
    dgemm(&TRANSA1, &TRANSB1, &m_t, &n_t, &k_t, &alpha1,
          &(((::coder::array<real_T, 1U> *)&A)->data())[0], &lda_t,
...
void mtimes(const emlrtStack &sp, const ::coder::array<real_T, 1U> &A,
            ...
            const ::coder::array<real_T, 1U> &B, ::coder::array<real_T, 1U> &C)
{
  ...
  if ((A.size(0) == 0) || (A.size(1) == 0) || (B.size(0) == 0)) {
    int32_T loop_ub;
    C.set_size(&he_emlrtRTEI, &sp, A.size(0));
    loop_ub = A.size(0);
    for (int32_T i{0}; i < loop_ub; i++) {
      C[i] = 0.0;
    }
    ...
    C.set_size(&ge_emlrtRTEI, &b_st, A.size(0));
    dgemm(&TRANSA1, &TRANSB1, &m_t, &n_t, &k_t, &alpha1,
          &(((::coder::array<real_T, 2U> *)&A)->data())[0], &lda_t,
          &(((::coder::array<real_T, 1U> *)&B)->data())[0], &ldb_t, &beta1,
          &(C.data())[0], &ldc_t);
            ...
            const ::coder::array<real_T, 2U> &B, ::coder::array<real_T, 2U> &C)
{
  ...
  if ((A.size(0) == 0) || (A.size(1) == 0) || (B.size(0) == 0) ||
      (B.size(1) == 0)) {
    int32_T loop_ub;
    C.set_size(&he_emlrtRTEI, &sp, A.size(0), B.size(1));
    ...
    ldb_t = (ptrdiff_t)B.size(0);
    ldc_t = (ptrdiff_t)A.size(0);
    C.set_size(&ge_emlrtRTEI, &b_st, A.size(0), B.size(1));
    dgemm(&TRANSA1, &TRANSB1, &m_t, &n_t, &k_t, &alpha1,
          &(((::coder::array<real_T, 2U> *)&A)->data())[0], &lda_t,
          &(((::coder::array<real_T, 2U> *)&B)->data())[0], &ldb_t, &beta1,
          &(C.data())[0], &ldc_t);
