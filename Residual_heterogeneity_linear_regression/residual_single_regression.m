function [result] = residual_single_regression(x, y, sample_size, row_size, col_size, beta_real, gamma_real,...
...
[beta_back, gamma_back, ~] = matrix_homogeneity_regression(x, y, index_store, sample_size, row_size, col_size, eps_initial, iter_max_initial_in);
...
[beta_back, gamma_back, convergence] = matrix_homogeneity_regression(x, y, index_store, sample_size, row_size, col_size, eps_initial, iter_max_initial_in);
% 计算估计参数的MSE
